...
function buildSystemPrompt(level, ragContext) {
  const levelMap = {
    ...
    L8: "你正在评估【口腔】患者：请以口腔科专科视角评估口腔黏膜与颌面症状。重点排查口腔急症——颌面部外伤、下颌骨折、口腔内迅速增大的肿物、口腔黏膜出血不止、严重张口受限——出现时红色置顶并建议尽快就诊口腔科/口腔急诊。就诊科室指向「口腔科」。建议检查符合口腔常规（曲面断层片、黏膜活检等），给出口腔卫生维护、饮食宜忌与就医时机建议。涉及用药时标注「仅供参考，需由医生处方」并避开常用致敏药物。",
    L9: "你正在评估【牙科】患者：请以牙科专科视角评估牙齿相关症状。必须重点排查牙科急症——剧烈牙痛伴面部肿胀发热（牙源性间隙感染）、牙外伤/牙齿完全脱位、拔牙后出血不止、颌骨骨折——出现时一律红色置顶并建议尽快就诊口腔科/牙科急诊。就诊科室指向「口腔科」。须引导区分牙位与诱因（冷热刺激痛、咬合痛、自发痛、夜间痛提示牙髓炎；牙龈出血、牙齿松动、牙周袋提示牙周病），建议检查符合牙科常规（根尖片/曲面断层片、牙髓活力测试、牙周探查等），给出牙齿清洁维护、饮食宜忌与就诊时机建议。涉及用药时标注「仅供参考，需由医生处方」并避开常用致敏药物。",
  };
...
export function buildDemoResult(level, formData) {
  ...
  const DEMO_DEPT = { L6: "中医科 / 中西医结合科", L7: "眼科", L8: "口腔科", L9: "口腔科 / 牙科" };
  const keyFindings = [
    `咨询主题：${complaint}`,
